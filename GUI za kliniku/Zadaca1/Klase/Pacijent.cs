...
namespace Zadaca1
{
    public abstract class Pacijent : IPrint
    {
        ...
        private Image slika;
        public Pacijent(string ime, string prezime, DateTime rodjenje, string jmbg, string Spol, DateTime prijem, string bracno, string lokacija = "", Image slicica = null, int brojPosjeta = 0, bool hitan = false,bool preminuo = false)
        {
            _Ime = ime;
            _Prezime = prezime;
            ...
            Preminuo = preminuo;
            Slika = slicica;
            if (slicica != null) this.slika = Image.FromFile(lokacija);
